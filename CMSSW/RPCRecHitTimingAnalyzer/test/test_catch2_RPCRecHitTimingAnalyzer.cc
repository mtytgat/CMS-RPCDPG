...
static constexpr auto s_tag = "[RPCRecHitTimingAnalyzer]";

TEST_CASE("Standard checks of RPCRecHitTimingAnalyzer", s_tag) {
  const std::string baseConfig{
R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("RPCRecHitTimingAnalyzer"
